...
const categoryData = [
  { title: 'Living Room', count: '12 Pieces', img: 'img/hall_3.jpeg', link: '/living' },
  { title: 'Bedroom Suites', count: '8 Pieces', img: 'img/bedroom_2.jpeg', link: '/bedroom' },
  { title: 'Modular Kitchens', count: 'Custom Fit', img: 'img/kichen_1.jpeg', link: '/collections' },
  { title: 'Custom Wardrobes', count: 'Floor-to-Ceiling', img: 'img/cupboard_1.jpeg', link: '/collections' },
  { title: 'Sacred Mandirs', count: 'Hand Carved', img: 'img/mandir_1.jpeg', link: '/collections' },
  { title: 'Balcony & Lounges', count: 'Weatherproof', img: 'img/balcony_9.jpeg', link: '/collections' },
];
  ...
  return (
    <>
      ...
      <section className="relative z-20 max-w-7xl mx-auto px-6 -mt-8">
        <div className={`rounded-2xl p-6 shadow-xl border grid grid-cols-2 md:grid-cols-4 gap-6 text-center ${isLightMode ? 'bg-white border-slate-200 shadow-md' : 'glass-panel border-white/10'
          }`}>
          <div className="p-3">
            <span className="text-3xl md:text-4xl font-black text-transparent bg-clip-text bg-gradient-to-r from-emerald-500 to-cyan-500">20+</span>
            <p className={`text-xs uppercase font-bold tracking-widest mt-1 ${isLightMode ? 'text-slate-500' : 'text-gray-400'}`}>Years Mastery</p>
          </div>
          <div className={`p-3 border-l ${isLightMode ? 'border-slate-200' : 'border-white/10'}`}>
            <span className="text-3xl md:text-4xl font-black text-transparent bg-clip-text bg-gradient-to-r from-cyan-500 to-blue-500">10k+</span>
            <p className={`text-xs uppercase font-bold tracking-widest mt-1 ${isLightMode ? 'text-slate-500' : 'text-gray-400'}`}>Custom Pieces</p>
          </div>
          <div className={`p-3 border-l ${isLightMode ? 'border-slate-200' : 'border-white/10'}`}>
            <span className="text-3xl md:text-4xl font-black text-transparent bg-clip-text bg-gradient-to-r from-blue-500 to-purple-500">100%</span>
            <p className={`text-xs uppercase font-bold tracking-widest mt-1 ${isLightMode ? 'text-slate-500' : 'text-gray-400'}`}>Solid Wood & Ply</p>
          </div>
          <div className={`p-3 border-l ${isLightMode ? 'border-slate-200' : 'border-white/10'}`}>
            <span className="text-3xl md:text-4xl font-black text-transparent bg-clip-text bg-gradient-to-r from-amber-500 to-yellow-500">15-Yr</span>
            <p className={`text-xs uppercase font-bold tracking-widest mt-1 ${isLightMode ? 'text-slate-500' : 'text-gray-400'}`}>Warranty Assurance</p>
          </div>
        </div>
      </section>
      ...
      <main className="relative overflow-hidden">
        ...
        <section className="max-w-7xl mx-auto px-6 py-24">
          <div className="text-center mb-16" data-aos="fade-up">
            ...
            <h2 className={`text-3xl sm:text-4xl md:text-5xl font-black tracking-tight mb-4 ${isLightMode ? 'text-slate-900' : 'text-white'
              }`}>
              Bespoke Spaces & <span className="animated-gradient-text">Architectural Joinery</span>
            </h2>
            <p className={`max-w-2xl mx-auto text-base ${isLightMode ? 'text-slate-600' : 'text-gray-400'}`}>
              Every home requires a custom touch. Browse our specialized woodworking solutions engineered to fit your distinct aesthetic.
            </p>
          </div>
        ...
        <section className={`py-20 border-y transition-colors duration-500 relative ${isLightMode ? 'bg-slate-50 border-slate-200' : 'bg-gray-900/40 border-white/10 backdrop-blur-xl'
          }`}>
          <div className="max-w-7xl mx-auto px-6">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div
                data-aos="fade-up"
                className={`p-8 rounded-3xl hover:-translate-y-2 transition-all duration-300 group ${isLightMode ? 'bg-white border border-slate-200 shadow-md' : 'gradient-border-luxury'
                  }`}
              >
                ...
                <p className={`text-sm leading-relaxed ${isLightMode ? 'text-slate-600' : 'text-gray-400'}`}>
                  We refuse cheap particle boards. Every build uses seasoned Burma Teak, natural wood veneers, and ISO BWP 710 marine grade plywood designed to resist moisture and termites for decades.
                </p>
              </div>
              ...
              >
                ...
                <p className={`text-sm leading-relaxed ${isLightMode ? 'text-slate-600' : 'text-gray-400'}`}>
                  Engineered with premium Hettich, Hafele, and Blum concealed hinges, tandem boxes, and hydraulic stays ensuring whisper-silent glides on all drawers and wardrobe doors.
                </p>
              </div>
              ...
              >
                ...
                <h3 className={`text-xl font-black mb-3 group-hover:text-amber-500 transition-colors ${isLightMode ? 'text-slate-900' : 'text-white'
                  }`}>
                  Artisanal Hand Polish & PU
                </h3>
                <p className={`text-sm leading-relaxed ${isLightMode ? 'text-slate-600' : 'text-gray-400'}`}>
                  Finished with multi-coat Italian Polyurethane (PU), Melamine, or deep hand-rubbed Danish oils for a rich, scratch-resistant lustre that highlights the natural beauty of real wood grains.
                </p>
              </div>
        ...
        <section className="py-24 max-w-7xl mx-auto px-6">
          ...
          <div className="flex flex-col lg:flex-row items-center gap-16 mb-24">
            <div data-aos="fade-right" className="w-full lg:w-1/2">
              ...
              <h3 className={`text-3xl sm:text-4xl font-black tracking-tight mb-6 leading-tight ${isLightMode ? 'text-slate-900' : 'text-white'
                }`}>
                Crafting Spaces That Inspire <span className="text-transparent bg-clip-text bg-gradient-to-r from-emerald-500 to-cyan-500">Everyday Living.</span>
              </h3>
              <p className={`leading-relaxed mb-6 ${isLightMode ? 'text-slate-600' : 'text-gray-300'}`}>
                At Rajesh Furniture Works, we believe custom furniture should be the soul of your home. We balance functional ergonomics with clean architectural profiles—seamlessly hiding entertainment wiring, incorporating acoustic fluted paneling, and ensuring effortless room flow.
              </p>

              <div className="grid grid-cols-2 gap-4 mb-8">
                <div className={`p-4 rounded-xl border ${isLightMode ? 'bg-white border-slate-200 shadow-sm' : 'bg-white/5 border-white/5'}`}>
                  <span className="block text-emerald-500 font-black text-xl">Custom Fit</span>
                  <span className={`text-xs ${isLightMode ? 'text-slate-500' : 'text-gray-400'}`}>Tailored to exact millimetres</span>
                </div>
                <div className={`p-4 rounded-xl border ${isLightMode ? 'bg-white border-slate-200 shadow-sm' : 'bg-white/5 border-white/5'}`}>
                  <span className="block text-cyan-500 font-black text-xl">Fluted Accents</span>
                  <span className={`text-xs ${isLightMode ? 'text-slate-500' : 'text-gray-400'}`}>Hand-carved wood louvers</span>
                </div>
              </div>
            ...
            <div data-aos="fade-left" data-aos-delay="200" className="w-full lg:w-1/2 relative group">
              ...
              <div className="relative rounded-3xl overflow-hidden border border-white/10 shadow-2xl">
                ...
                <div className="absolute bottom-6 left-6 right-6 p-4 rounded-2xl bg-black/75 backdrop-blur-md border border-white/20 text-white keep-white flex justify-between items-center shadow-lg">
                  <div>
                    <h4 className="text-sm font-bold text-white keep-white">Modern Villa Hallway & TV Console</h4>
                    <p className="text-xs text-gray-200 keep-white-sub">Teak finish with concealed warm ambient LEDs</p>
                  </div>
          ...
          <div className="flex flex-col-reverse lg:flex-row items-center gap-16">
            <div data-aos="fade-right" data-aos-delay="200" className="w-full lg:w-1/2 relative group">
              ...
              <div className="relative rounded-3xl overflow-hidden border border-white/10 shadow-2xl">
                ...
                <div className="absolute bottom-6 left-6 right-6 p-4 rounded-2xl bg-black/75 backdrop-blur-md border border-white/20 text-white keep-white flex justify-between items-center shadow-lg">
                  <div>
                    <h4 className="text-sm font-bold text-white keep-white">High-Gloss Acrylic Kitchen Suite</h4>
                    <p className="text-xs text-gray-200 keep-white-sub">Boiling waterproof 710 ply with tandem pull-outs</p>
                  </div>
            ...
            <div data-aos="fade-left" className="w-full lg:w-1/2">
              ...
              <h3 className={`text-3xl sm:text-4xl font-black tracking-tight mb-6 leading-tight ${isLightMode ? 'text-slate-900' : 'text-white'
                ...
                Modular Kitchens Built For <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-500 to-blue-600">Indian Cooking.</span>
              </h3>
              <p className={`leading-relaxed mb-6 ${isLightMode ? 'text-slate-600' : 'text-gray-300'}`}>
                Indian kitchens demand superior resistance to steam, spices, heavy cookware, and daily scrubbing. We engineer every cabinet with genuine BWP 710 marine grade plywood, anti-rust stainless steel baskets, and scratch-proof acrylic shutters built to stay immaculate for decades.
              </p>

              <ul className="space-y-3 mb-8 text-sm">
                <li className={`flex items-center gap-3 ${isLightMode ? 'text-slate-700' : 'text-gray-300'}`}>
                  <span className="text-emerald-500 font-bold">✓</span>
                  <span>100% Termite, borer, and boiling water resistant inner carcases</span>
                </li>
                <li className={`flex items-center gap-3 ${isLightMode ? 'text-slate-700' : 'text-gray-300'}`}>
                  <span className="text-emerald-500 font-bold">✓</span>
                  <span>Corner carousel units and pantry pull-outs for maximum storage</span>
                </li>
                <li className={`flex items-center gap-3 ${isLightMode ? 'text-slate-700' : 'text-gray-300'}`}>
                  <span className="text-emerald-500 font-bold">✓</span>
                  <span>Integrated space for chimney, built-in oven, and quartz countertops</span>
                </li>
              </ul>

              <Link
                to="/contact"
                className={`inline-flex items-center gap-2 px-6 py-3.5 rounded-xl border text-xs font-bold tracking-wider transition-all ${isLightMode
        ...
        <section className={`py-24 border-t transition-colors duration-500 ${isLightMode ? 'bg-slate-50 border-slate-200' : 'bg-gray-900/30 border-white/10'
          }`}>
          <div className="max-w-7xl mx-auto px-6">
            ...
            <div className="text-center mb-16" data-aos="fade-up">
              ...
              <h2 className={`text-3xl sm:text-4xl md:text-5xl font-black tracking-tight mb-4 ${isLightMode ? 'text-slate-900' : 'text-white'
                ...
                Our 4-Step <span className="animated-gradient-text">Master Joinery Process</span>
              </h2>
              <p className={`max-w-xl mx-auto text-sm ${isLightMode ? 'text-slate-600' : 'text-gray-400'}`}>
                From initial chalk sketches to polished white-glove handover, experience hassle-free craftsmanship.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {stepsData.map((item, idx) => (
                <div
                  ...
                  className={`p-6 rounded-3xl border transition-all duration-300 group hover:-translate-y-2 relative ${isLightMode
                ...
                >
                  ...
                  <h3 className={`text-lg font-black mb-2 group-hover:text-emerald-500 transition-colors ${isLightMode ? 'text-slate-900' : 'text-white'
                    }`}>
                    {item.title}
                  </h3>
        ...
        <section className="py-24 max-w-7xl mx-auto px-6">
          <div className="text-center mb-16" data-aos="fade-up">
            ...
            <h2 className={`text-3xl sm:text-4xl font-black tracking-tight mb-4 ${isLightMode ? 'text-slate-900' : 'text-white'
              }`}>
              Trusted By Mumbai & Thane's <span className="amber-gradient-text">Finest Residences</span>
            </h2>
            <p className={`max-w-xl mx-auto text-sm ${isLightMode ? 'text-slate-600' : 'text-gray-400'}`}>
              Read how our bespoke woodwork elevated living spaces across leading residential towers.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {testimonials.map((review, idx) => (
              <div
                ...
                data-aos="fade-up"
                data-aos-delay={idx * 150}
                className={`p-8 rounded-3xl flex flex-col justify-between ${isLightMode
              ...
              >
                <div>
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <span className={`px-2.5 py-0.5 rounded-full text-[10px] font-semibold border ${isLightMode ? 'bg-slate-100 border-slate-200 text-slate-600' : 'bg-white/5 border-white/10 text-gray-400'
                      }`}>
                      {review.tag}
                    </span>
                  </div>

                  <p className={`text-sm leading-relaxed mb-6 italic ${isLightMode ? 'text-slate-700' : 'text-gray-300'
                    }`}>
                    "{review.text}"
                  </p>
                </div>

                <div className={`pt-4 border-t flex items-center gap-3 ${isLightMode ? 'border-slate-100' : 'border-white/5'
                  }`}>
                  ...
                  <div>
                    ...
                    <p className={`text-[11px] ${isLightMode ? 'text-slate-500' : 'text-gray-400'}`}>
                      {review.location}
                    </p>
                  </div>
                </div>
          ...
          >
            ...
            <div className="relative z-10 max-w-3xl mx-auto">
              ...
              <p className="text-gray-200 keep-white-sub text-base sm:text-lg mb-8 leading-relaxed">
                Connect directly with our master craftsmen. Bring your floor plans, sketches, or ideas for a free estimation and material consultation.
              </p>
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="w-full sm:w-auto px-8 py-4 rounded-xl btn-gradient-shimmer text-gray-950 font-black text-sm tracking-wider flex items-center justify-center gap-2 shadow-xl cursor-pointer"
                >
                ...
                <a
                  ...
                  className="w-full sm:w-auto px-8 py-4 rounded-xl bg-white/10 hover:bg-white/20 border border-white/25 text-white keep-white font-bold text-sm tracking-wider backdrop-blur-md transition-all flex items-center justify-center gap-2 cursor-pointer"
                >
                ...
                <Link
                  to="/contact"
                  className="w-full sm:w-auto px-8 py-4 rounded-xl bg-transparent hover:bg-white/10 border border-white/25 text-white keep-white font-bold text-sm tracking-wider transition-all"
                >
                  VISIT WORKSHOP
                </Link>
              </div>
