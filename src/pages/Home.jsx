    ...
    <> 
      ...
      <main>
        <section className="max-w-7xl mx-auto px-6 py-24">
          <div className="text-center mb-16 lg:my-20" data-aos="fade-up">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 lg:my-15">
            ...
            <div data-aos="fade-up" className="group p-6 rounded-2xl bg-gray-800/50 border border-gray-700 backdrop-blur-sm hover:-translate-y-2 transition-transform duration-300">
            ...
            {/* Card 2 - Appears after 300ms */}
            <div data-aos="fade-up" data-aos-delay="300" className="group p-6 rounded-2xl bg-gray-800/50 border border-gray-700 backdrop-blur-sm hover:-translate-y-2 transition-transform duration-300">
              <div className="h-56 w-full rounded-xl overflow-hidden mb-6 relative">
            ...
            <div data-aos="fade-up" data-aos-delay="600" className="group p-6 rounded-2xl bg-gray-800/50 border border-gray-700 backdrop-blur-sm hover:-translate-y-2 transition-transform duration-300">
              <div className="h-56 w-full rounded-xl overflow-hidden mb-6 relative">
        ...
        <section className="border-b border-white/5 bg-gray-900/50 mb-20">
          <div className="max-w-7xl mx-auto px-6 py-16 grid grid-cols-1 md:grid-cols-3 gap-10">
            ...
            {/* Feature 2 - Appears 300ms later */}
            <div data-aos="fade-up" data-aos-delay="300" className="flex items-start space-x-4">
            ...
            {/* Feature 3 - Appears 600ms later */}
            <div data-aos="fade-up" data-aos-delay="600" className="flex items-start space-x-4">
        ...
        <section className="py-2 max-w-7xl mx-auto px-6 overflow-hidden">
          <div className="flex flex-col lg:flex-row items-center gap-16">
            ...
            {/* Image slides in from the right after a 300ms delay */}
            <div data-aos="fade-left" data-aos-delay="300" className="w-full lg:w-1/2 relative group">
        ...
        <section className="py-2 max-w-7xl mx-auto px-6 py-15 overflow-hidden">
          <div className="flex flex-col-reverse lg:flex-row items-center gap-16">
            {/* Image slides in from the left */}
            <div data-aos="fade-right" className="w-full lg:w-1/2 relative group">
              <div className="absolute inset-0 bg-gradient-to-tr from-blue-600/20 to-purple-600/20 rounded-2xl blur-xl transition-all duration-500 group-hover:blur-2xl"></div>
            ...
            {/* Text slides in from the right after a 300ms delay */}
