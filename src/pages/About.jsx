    ...
    <main>
        ...
        <div className="flex flex-col lg:flex-row items-center gap-16">
          ...
          <div className="w-full lg:w-1/2 relative h-[600px]">
            <div className="absolute top-0 right-0 w-4/5 h-[400px] rounded-3xl overflow-hidden shadow-2xl border border-gray-700/50 transition-transform duration-700 hover:scale-[1.03] hover:-rotate-1 z-10 cursor-pointer">
              ...
              <img src="https://images.unsplash.com/photo-1600607686527-6fb886090705?auto=format&fit=crop&q=80&w=1000" alt="Design Sketching" className="w-full h-full object-cover" />
            </div>
            <div className="absolute bottom-0 left-0 w-3/5 h-[350px] rounded-3xl overflow-hidden shadow-[0_20px_50px_rgba(0,0,0,0.5)] border-2 border-gray-950 animate-float-delay z-20 transition-transform duration-700 hover:scale-105 hover:rotate-2 cursor-pointer">
              ...
              <img src="https://images.unsplash.com/photo-1538688525198-9b88f6f53126?auto=format&fit=crop&q=80&w=800" alt="Woodworking" className="w-full h-full object-cover" />
            </div>
          </div>
        </div>
      </section>

      {/* CORE VALUES SECTION WITH UNIFIED HOVER GRADIENTS */}
      <section className={`py-24 border-t border-b relative transition-colors duration-500 ${isLightMode ? 'bg-[#f8fafc] border-slate-200' : 'bg-gradient-to-b from-gray-950 via-gray-900 to-gray-950 border-white/5'}`}>
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 relative z-10">
            ...
            {/* CARD 1 */}
            <div className={`relative group rounded-3xl transition-all duration-500 hover:-translate-y-4 border ${isLightMode ? 'border-slate-200 shadow-md hover:shadow-2xl hover:border-transparent' : 'border-gray-800 hover:border-transparent hover:shadow-[0_10px_30px_-10px_rgba(52,211,153,0.4)]'}`}>
              ...
              {/* HOVER FULL GRADIENT - NOW IDENTICAL FOR BOTH MODES */}
              <div 
                className="absolute inset-0 rounded-3xl opacity-0 group-hover:opacity-100 transition-opacity duration-500"
                style={{ background: 'linear-gradient(to bottom right, rgba(52, 211, 153, 0.8), rgba(6, 182, 212, 0.5), rgba(168, 85, 247, 0.3))' }}
              ></div>

              {/* UN-HOVERED BORDER GLOW - IDENTICAL FOR BOTH MODES */}
              <div 
                className="absolute inset-0 z-[-2] -m-[1px] rounded-[inherit] opacity-30 group-hover:opacity-0 transition-opacity duration-500"
                style={{ background: 'linear-gradient(to bottom right, rgba(52, 211, 153, 0.5), rgba(6, 182, 212, 0.1), rgba(17, 24, 39, 1))' }}
              ></div>
              ...
              <div className="relative z-10 p-8 h-full flex flex-col">
                ...
                <h3 className={`text-2xl font-bold mb-4 transition-colors duration-300 ${isLightMode ? 'text-slate-900 group-hover:text-slate-900' : 'text-white group-hover:text-transparent group-hover:bg-clip-text group-hover:bg-gradient-to-r group-hover:from-emerald-400 group-hover:to-cyan-400'}`}>
            ...
            {/* CARD 2 */}
            <div className={`relative group rounded-3xl transition-all duration-500 hover:-translate-y-4 border ${isLightMode ? 'border-slate-200 shadow-md hover:shadow-2xl hover:border-transparent' : 'border-gray-800 hover:border-transparent hover:shadow-[0_10px_30px_-10px_rgba(6,182,212,0.4)]'}`}>
              ...
              <div className="relative z-10 p-8 h-full flex flex-col">
                ...
                <h3 className={`text-2xl font-bold mb-4 transition-colors duration-300 ${isLightMode ? 'text-slate-900 group-hover:text-slate-900' : 'text-white group-hover:text-transparent group-hover:bg-clip-text group-hover:bg-gradient-to-r group-hover:from-cyan-400 group-hover:to-blue-400'}`}>
            ...
            {/* CARD 3 */}
            <div className={`relative group rounded-3xl transition-all duration-500 hover:-translate-y-4 border ${isLightMode ? 'border-slate-200 shadow-md hover:shadow-2xl hover:border-transparent' : 'border-gray-800 hover:border-transparent hover:shadow-[0_10px_30px_-10px_rgba(168,85,247,0.4)]'}`}>
              ...
              <div className="relative z-10 p-8 h-full flex flex-col">
                ...
                <h3 className={`text-2xl font-bold mb-4 transition-colors duration-300 ${isLightMode ? 'text-slate-900 group-hover:text-slate-900' : 'text-white group-hover:text-transparent group-hover:bg-clip-text group-hover:bg-gradient-to-r group-hover:from-purple-400 group-hover:to-pink-400'}`}>
                  Form Meets Function
                </h3>
                <p className={`leading-relaxed transition-colors duration-300 ${isLightMode ? 'text-slate-600 group-hover:text-slate-900' : 'text-gray-400 group-hover:text-gray-200'}`}>
      ...
      <section className="py-24 relative overflow-hidden flex items-center justify-center text-center px-6">
        ...
        <div className="relative z-20 max-w-3xl mx-auto group">
          <h2 className="text-4xl md:text-6xl font-black mb-8 text-white transition-transform duration-500 group-hover:scale-105">
