...
export default function Contact() {
  ...
  const [selectedProjectType, setSelectedProjectType] = useState('Full Home Interior');
  ...
  return (
    <>
      ...
      <header className={`pt-32 pb-12 relative z-10 text-center px-6 overflow-hidden transition-colors duration-500 ${
        ...
        <div className="relative z-10 max-w-3xl mx-auto" data-aos="fade-down">
          ...
          <h1 className={`text-4xl sm:text-6xl md:text-7xl font-black mb-4 tracking-tight ${
          ...
          <p className={`text-sm sm:text-base md:text-lg max-w-2xl mx-auto leading-relaxed ${
            ...
            Have a blueprint, need custom sizing, or want to discuss a turnkey apartment interior? Connect directly with our workshop team.
          </p>
        </div>
      </header>
      ...
      <main className="max-w-7xl mx-auto px-6 py-12 relative overflow-hidden">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 relative z-10 mb-20">
          ...
          <div className="lg:col-span-5 flex flex-col justify-between space-y-6">
            ...
            <div data-aos="fade-up" className={`p-6 rounded-3xl border transition-all group ${
              isLightMode ? 'bg-white border-slate-200 shadow-md' : 'gradient-border-luxury'
            }`}>
              <div className="flex items-start gap-5">
                ...
                <div className="flex-1">
                  <h4 className={`text-lg font-bold mb-1 ${isLightMode ? 'text-slate-900' : 'text-white'}`}>Visit Our Workshop</h4>
                  <p className={`text-xs leading-relaxed mb-3 ${isLightMode ? 'text-slate-600' : 'text-gray-400'}`}>
                    204, 2nd floor, blodge:D-2<br />
                    Shree Ganesh Residency, Maitri Park, Kasheli, Bhiwandi, Maharashtra 421302
                  </p>
                  <a 
            ...
            <div data-aos="fade-up" data-aos-delay="150" className={`p-6 rounded-3xl border transition-all group ${
              isLightMode ? 'bg-white border-slate-200 shadow-md' : 'gradient-border-luxury'
            }`}>
              <div className="flex items-start gap-5">
                ...
                <div className="flex-1">
                  <h4 className={`text-lg font-bold mb-1 ${isLightMode ? 'text-slate-900' : 'text-white'}`}>Instant WhatsApp Consultation</h4>
                  <p className={`text-xs mb-3 ${isLightMode ? 'text-slate-600' : 'text-gray-400'}`}>
                    Chat directly with our master carpenter. Send photos or floor plans for instantaneous estimates.
                  </p>
                  <a 
                    ...
                    target="_blank" 
                    rel="noreferrer"
                    className="inline-flex items-center gap-1.5 px-4 py-2 rounded-xl btn-gradient-shimmer text-gray-950 text-xs font-bold shadow-md"
                  >
                    <span>Chat on WhatsApp (+91 98208 79871)</span>
                    <span>→</span>
                  </a>
                </div>
              </div>
            ...
            <div data-aos="fade-up" data-aos-delay="300" className={`p-6 rounded-3xl border transition-all group ${
              isLightMode ? 'bg-white border-slate-200 shadow-md' : 'gradient-border-luxury'
            }`}>
              <div className="flex items-start gap-5">
                ...
                <div className="flex-1">
                  <h4 className={`text-lg font-bold mb-1 ${isLightMode ? 'text-slate-900' : 'text-white'}`}>Phone Inquiries</h4>
                  <div className="space-y-1 text-sm mb-3">
                    <a href="tel:+919820879871" className={`block font-bold transition-colors ${
                      isLightMode ? 'text-slate-900 hover:text-cyan-600' : 'text-white hover:text-cyan-400'
                    }`}>
                      +91 98208 79871
                    </a>
                    <a href="tel:+919920706036" className={`block font-bold transition-colors ${
                      isLightMode ? 'text-slate-900 hover:text-cyan-600' : 'text-white hover:text-cyan-400'
                    }`}>
                      +91 99207 06036
                    </a>
            ...
            <div data-aos="fade-up" data-aos-delay="450" className={`p-6 rounded-3xl border transition-all group ${
              isLightMode ? 'bg-white border-slate-200 shadow-md' : 'gradient-border-luxury'
            }`}>
              <div className="flex items-start gap-5">
                ...
                <div className="flex-1 min-w-0">
                  <h4 className={`text-lg font-bold mb-1 ${isLightMode ? 'text-slate-900' : 'text-white'}`}>Email Inquiries</h4>
                  <div className="space-y-1 text-xs">
                    <a href="mailto:rv9766444@gmail.com" className={`block truncate transition-colors ${
                      isLightMode ? 'text-slate-700 hover:text-purple-700 font-medium' : 'text-gray-300 hover:text-purple-400'
                    }`}>
                      rv9766444@gmail.com
                    </a>
                    <a href="mailto:vishwakarmaranjit8109@gmail.com" className={`block truncate transition-colors ${
                      isLightMode ? 'text-slate-700 hover:text-purple-700 font-medium' : 'text-gray-300 hover:text-purple-400'
                    }`}>
          ...
          <div className="lg:col-span-7" data-aos="fade-up" data-aos-delay="200">
            <div className={`p-8 sm:p-10 rounded-[2.5rem] border shadow-xl relative ${
              isLightMode ? 'bg-white border-slate-200 shadow-xl' : 'glass-panel border-white/10 shadow-2xl'
            }`}>
              <div className="absolute top-0 right-0 w-64 h-64 bg-emerald-500/10 rounded-full blur-[100px] pointer-events-none"></div>

              <div className="relative z-10">
                <h3 className={`text-2xl sm:text-3xl font-black mb-2 ${isLightMode ? 'text-slate-900' : 'text-white'}`}>
                  Send A Project Blueprint
                </h3>
                <p className={`text-xs sm:text-sm mb-6 ${isLightMode ? 'text-slate-600' : 'text-gray-400'}`}>
                  Fill out the form below. We will analyze your requirements and get back to you within 24 hours.
                </p>
                ...
                <form ref={form} onSubmit={sendEmail} className="space-y-5">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                      <label htmlFor="name" className={`block text-xs font-bold tracking-wider uppercase mb-1.5 ${
                        isLightMode ? 'text-slate-700' : 'text-gray-300'
                      }`}>
                        Your Full Name *
                      </label>
                    ...
                    <div>
                      <label htmlFor="phone" className={`block text-xs font-bold tracking-wider uppercase mb-1.5 ${
                        isLightMode ? 'text-slate-700' : 'text-gray-300'
                      }`}>
                  ...
                  <div>
                    <label htmlFor="email" className={`block text-xs font-bold tracking-wider uppercase mb-1.5 ${
                      isLightMode ? 'text-slate-700' : 'text-gray-300'
                    }`}>
                      Email Address *
                    </label>
                  ...
                  <div>
                    <label htmlFor="location" className={`block text-xs font-bold tracking-wider uppercase mb-1.5 ${
                      isLightMode ? 'text-slate-700' : 'text-gray-300'
                    }`}>
                  ...
                  <div>
                    <label htmlFor="message" className={`block text-xs font-bold tracking-wider uppercase mb-1.5 ${
                      isLightMode ? 'text-slate-700' : 'text-gray-300'
                    }`}>
                  ...
                  <button 
                    ...
                    className={`w-full py-4 rounded-xl btn-gradient-shimmer text-gray-950 font-black text-sm tracking-wider flex justify-center items-center gap-2 shadow-lg cursor-pointer ${
                      status === 'loading' ? 'opacity-75 cursor-not-allowed pointer-events-none' : ''
                    }`}
                  >
                    <span>
        ...
        <section className={`pt-12 border-t ${isLightMode ? 'border-slate-200' : 'border-white/10'}`}>
          <div className="text-center mb-12" data-aos="fade-up">
            <span className="text-xs font-black tracking-widest text-cyan-500 uppercase block mb-2">
              Common Questions
            </span>
            <h2 className={`text-2xl sm:text-4xl font-black tracking-tight ${isLightMode ? 'text-slate-900' : 'text-white'}`}>
              ...
              >
                ...
                {openFaq === idx && (
                  <div className={`px-6 pb-6 text-xs sm:text-sm leading-relaxed border-t pt-4 ${
                    isLightMode ? 'border-slate-100 text-slate-600' : 'border-white/5 text-gray-300'
                  }`}>
                    {faq.a}
                  </div>
                )}
