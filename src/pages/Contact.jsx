...
export default function Contact() {
  ...
  return (
    <>
      {/* 1. SEPARATED AOS WRAPPER FOR HEADER */}
      ...
      <main className="max-w-7xl mx-auto px-6 py-12 relative overflow-hidden">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 relative z-10">
          ...
          <div className="flex flex-col justify-center space-y-12">
            ...
            {/* 2. SEPARATED AOS WRAPPER FOR SHOP CARD */}
            ...
            {/* 3. SEPARATED AOS WRAPPER FOR EMAIL CARD */}
            ...
            {/* 4. SEPARATED AOS WRAPPER FOR CALL CARD */}
          ...
          {/* RIGHT: CONTACT FORM */}
          {/* 5. SEPARATED AOS WRAPPER FOR FORM */}
          <div data-aos="fade-up" data-aos-delay="300" className="w-full">
            <div className={`backdrop-blur-xl border p-8 md:p-10 rounded-[2rem] shadow-2xl relative transition-colors duration-300 w-full ${isLightMode ? 'bg-white border-slate-200' : 'bg-gray-950 border-gray-700/50'}`}>
              ...
              <form ref={form} onSubmit={sendEmail} className="space-y-6 relative z-10 w-full">
                <div>
